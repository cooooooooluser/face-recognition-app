...
ImgClassifier=ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/H5WodaQ8-/model.json", modelLoaded);
...
function gotresult(error, results) {
    if (error) {
        ...
        if (prediction1 == "car") {
            document.getElementById("Emoji-1").innerHTML = "U+1F697";

        }

        if (prediction1 == "nothing") {
            document.getElementById("Emoji-1").innerHTML = "nothing";
        ...
        if (prediction1 == "hardrive") {
            document.getElementById("Emoji-1").innerHTML = "&#128436";
             
        }

        if (prediction2 == "nothing") {
            document.getElementById("Emoji-2").innerHTML = "nothing";
             
        }

        if (prediction2 == "car") {
            document.getElementById("Emoji-2").innerHTML = "U+1F697";
             
        }

        if (prediction2 == "hardrive") {
            document.getElementById("Emoji-2").innerHTML = "&#128436";
